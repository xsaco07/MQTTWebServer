...
const socket = require('./src/socketEvents/sockets');
...
const totalRoutes = require('./src/routes/totalRoutes');
const towelConsumptionRoutes = require('./src/routes/towelConsumptionRoutes');
const waterConsumptionRoutes = require('./src/routes/waterConsumptionRoutes');

// Use cases
const useCases = require('./src/use-cases/useCases');

// DB
const {makeDB} = require('./src/data-access/mongodb');
